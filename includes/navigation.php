            ...
            <div class="flex justify-between">
                <div class="flex space-x-7">
                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        <a href="index.php" class="py-4 px-2 text-blue-600 border-b-4 border-blue-600">Home</a>
                        <a href="gallery.php" class="py-4 px-2 text-blue-600 border-b-4 border-blue-600">Gallery</a>
                        <a href="favorites.php" class="py-4 px-2 text-gray-700 hover:text-blue-600 transition duration-300">Favorites</a>
                        <a href="payment.php" class="py-4 px-2 text-gray-700 hover:text-blue-600 transition duration-300">Cart</a>
                    </div>
                </div>
                <!-- Secondary Navbar items -->
                 ...
                 if (isset($_SESSION['user_id'])) {
                     ...
                     echo '<div class="hidden md:flex items-center space-x-3">
                             <a href="user_gallery.php" class="py-2 px-2 font-medium text-gray-700 hover:text-blue-600 transition duration-300">My gallery</a>
                     ...
                     echo '<div class="hidden md:flex items-center space-x-3">
                             <a href="signin.php" class="py-2 px-2 font-medium text-gray-700 hover:text-blue-600 transition duration-300">Sign In</a>
